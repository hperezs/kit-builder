...
export default function SelectedSelfMadeProduct({
  product,
  index,
  deleteSMProduct,
  ...
  return (
    <div
      ...
      className="relative flex flex-col justify-start items-center mx-5 sm:mb-5 lg:mb-3 rounded px-5 pt-7 pb-10 border border-gray-300 shadow"
    >
      ...
      <div className="flex flex-col items-center">
        ...
        {isEditing && (
          <button
            onClick={(e) => {
              updateSMProductQuantity(index, quantity);
              setIsEditing(false);
            }}
