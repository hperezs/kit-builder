...
export default function CableProduct({ cable, handleSelect, displayNote }) {
  ...
  const card_styles =
    "flex flex-col justify-start items-center sm:my-4 lg:my-14 mx-5 rounded p-3 border bg-white shadow-xl ";
          ...
          >
            <Image
              src={
                ...
                cable.media_gallery_entries[0].file
              }
              layout="fill"
              objectFit="contain"
              quality={100}
