...
export default function VideoRecorder({ nvr, handleSelect, isRecommended }) {
  ...
  const card_styles =
    "relative flex flex-col justify-start items-center my-10 mx-3 rounded p-3 bg-white shadow-xl hover:border-green-300 ";
  ...
  return (
    ...
    >
      <div
        className={
          "absolute -top-10 font-light text-xl text-green-600 " +
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="font-light mb-1">
          Supports up to {nvr.channelCount} cameras
        </p>
        ...
        <p className="font-normal text-green-600">
          ${nvr.price.$numberDecimal}
        </p>
        <button
          className={selectButton_styles}
          onClick={(e) => handleSelect(nvr)}
        >
          Select
        </button>
        <a
          href={backstreet_domain + nvr.productLink}
          target="_blank"
          className="font-light text-green-600 hover:text-green-400"
        >
          See more details
        </a>
      </div>
