...
export default function Monitors({
  ...
  const card_styles =
    "relative flex flex-col justify-start items-center sm:my-5 lg:my-10 mx-3 rounded px-3 py-5 bg-white border shadow-xl hover:border-green-300 ";
  const selectButton_styles =
    "px-5 py-1 mb-4 border rounded bg-green-600 text-white text-sm uppercase tracking-wider font-semibold mt-3 transition hover:bg-green-400 focus:outline-none focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-500 ";

  return (
    <section id="monitors" className="pt-10">
      <p className="text-center text-lg sm:px-4 lg:px-0">
        Video Recorders do not include a monitor, so it is recommended that you
        purchase one.
      </p>
      {isChoosing && (
        <div
          transition-style="in:wipe:right"
          className="mt-10 border rounded p-10 bg-gray-100 sm:mx-4 lg:mx-0"
        >
          <div className="flex flex-row justify-center flex-wrap">
            {monitorProducts.length != 0 &&
              monitorProducts.map((product, index) => {
                if (product.sku.includes("MON"))
                  return (
                    <div
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <button
                          ...
                          onClick={(e) => handleSelect(product)}
                        >
                          Add to cart
                        </button>
                      </div>
      ...
      {!isChoosing && (
        <div
          ...
          className="flex flex-col items-center mt-10 sm:mx-4 lg:mx-0 border border-gray-300 rounded sm:p-5 lg:p-10 shadow"
        >
          <h4 className="font-light text-xl">Your selection:</h4>
          <div
            style={
              window?.innerWidth > 800
                ? { minHeight: "412px", minWidth: "488px" }
                : { width: "auto" }
            }
          ...
          >
            ...
            {selectedMonitor != "" && (
              ...
              >
                    ...
                    >
                      <Image
                        src={
                          backstreet_domain +
                          "/pub/media/catalog/product" +
                          selectedMonitor.media_gallery_entries[0].file
                        }
                        layout="fill"
                        objectFit="contain"
                        quality={20}
                ...
                <div className="flex flex-col items-center mt-3 mb-4">
                  ...
                  <p className="font-normal text-green-600">
                    ${selectedMonitor.price.toFixed(2)}
                  </p>
                </div>
                <span
                  onClick={(e) => {
            ...
            {!selectedMonitor?.cable && !isAddingHDMI && (
              <div
                ...
                onClick={(e) => {
                  setIsAddingHDMI(true);
                }}
              >
                <span className="text-5xl my-6 text-green-600 opacity-90">
                  <FiPlus />
                </span>
            ...
            {isAddingHDMI && (
              <div transition-style="fade:in" className={card_styles}>
                    ...
                    >
                      <Image
                        src={
                          backstreet_domain +
                          "/pub/media/catalog/product" +
                          monitorProducts[0].media_gallery_entries[0].file
                        }
                        layout="fill"
                        objectFit="contain"
                        quality={20}
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-normal text-green-600">
                    ${monitorProducts[0].price.toFixed(2)}
                  </p>
                  <button
                    className={selectButton_styles}
                    onClick={(e) => handleSelect(monitorProducts[0])}
                  >
                    Add to cart
                  </button>
                </div>
            ...
            {selectedMonitor?.cable && (
              ...
              >
                    ...
                    >
                      <Image
                        src={
                          backstreet_domain +
                          "/pub/media/catalog/product" +
                          selectedMonitor.cable.media_gallery_entries[0].file
                        }
                        layout="fill"
                        objectFit="contain"
                        quality={20}
                ...
                <div className="flex flex-col items-center mt-3 mb-4">
                  ...
                  <p className="font-normal text-green-600">
                    ${selectedMonitor.cable.price.toFixed(2)}
                  </p>
                </div>
                <span
                  onClick={(e) => {
                    deleteHDMI();
                    setSelectedHDMI(null);
                  }}
                  className={"absolute bottom-0 right-0 cursor-pointer p-2 "}
                >
                  <FaTrashAlt className="fill-current text-red-600 text-xl hover:text-red-400" />
