...
export default function RecommendedMount({ product, cameraIndex, addMount }) {
  const card_styles =
    "relative flex flex-col justify-start items-center my-10 mx-3 rounded px-5 py-7 bg-white border shadow-xl hover:border-green-300 ";
    ...
    <div transition-style="fade:in:fast" className={card_styles}>
      ...
      <div className="flex flex-col items-center">
        ...
        <button
          ...
          onClick={(e) => addMount(cameraIndex, product)}
        >
          Add to cart
        </button>
      </div>
