              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div style={{minHeight: '400px', maxWidth: '700px'}} className="relative sm:p-3 lg:p-6">
                    <div className="mx-3 sm:text-lg lg:text-xl flex flex-col items-center">
                        ...
                        <Image src="/images/promo-code.jpg" width={600} height={300} />

                        <div style={{maxWidth: "400px"}} className="text-lg mt-5 text-center"><span className="text-green-600 text-2xl font-light mr-2">&#8594;</span>Head over to our checkout page and use the code <span className="text-green-600 font-semibold">SPRINGGREEN</span> for a discount.</div>
