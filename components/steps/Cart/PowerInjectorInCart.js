...
export default function PowerInjectorInCart({product, cablesType, goToStep, deletePowerInjector, index, isReviewStep}) {
    ...
    return(
        <div 
            ...
            className={"relative flex flex-row justify-start items-center mb-3 rounded sm:p-2 lg:p-5 sm:mx-3 lg:mx-0 border bg-white border-gray-300 shadow " + (isReviewStep ? '' : 'lg:w-7/12')} 
        >
            <div className="xl:m-2 xl:p-3 flex flex-col justify-center items-center rounded border-gray-300 ">
                <div style={{height: '66px', width: (window?.screen > 800 ? '100px' : '70px')}}> 
