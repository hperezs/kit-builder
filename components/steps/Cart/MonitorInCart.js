...
export default function MonitorInCart({
  selectedMonitor,
  cablesType,
  goToStep,
  deleteMonitor,
  ...
  return (
    <div
      ...
      className={
        "relative flex flex-row justify-start items-center py-4 px-5 sm:mx-3 lg:mx-0 border rounded flex-shrink-0 bg-white border-gray-300 shadow lg:w-6/12"
      }
    >
      ...
      {displayEditButton && <DeleteModal confirmDelete={deleteMonitor} />}
    </div>
  );
}
