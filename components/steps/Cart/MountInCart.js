...
export default function MountInCart({
  camera,
  cablesType,
  goToStep,
  deleteMount,
  ...
  if (!camera?.mount)
    return (
      <div
        ...
        className={
          "relative flex flex-col items-center justify-center border rounded p-3 ml-3 sm:mr-3 lg:mr-0 sm:mt-3 lg:mt-0 bg-white border-gray-300 shadow lg:w-3/12"
        }
      >
  ...
  return (
    <div
      ...
      onMouseLeave={(e) => setDisplayEditButton(false)}
      className={
        "relative flex flex-col items-center justify-center border rounded p-4 ml-3 sm:mr-3 lg:mr-0 sm:mt-3 lg:mt-0 bg-white border-gray-300 shadow min-h-max lg:w-3/12"
      }
    >
