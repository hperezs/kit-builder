...
export default function InstallationInCart({
  homeOrBusiness,
  cablesType,
  cameras,
  goToStep,
  ...
  return (
    <div
      ...
      className={
        "relative flex flex-row justify-start items-center mb-3 sm:mx-3 lg:mx-0 rounded p-5 border bg-white border-gray-300 shadow overflow-hidden transition-all duration-500 ease " +
    ...
    >
      <div
        ...
        className={
          "absolute flex flex-col justify-center items-center border-gray-300 transition-all duration-500 ease "
        }
      >
        <div
          className="rounded"
          style={{
            height: "86px",
            width: window?.screen > 800 ? "100px" : "80px",
          }}
        >
          <div
          ...
          left:
            window?.innerWidth > 800
              ...
              : displayMoreDetails
                ? "37%"
                : "35%",
          top: displayMoreDetails ? "15%" : "30%",
        }}
        className={
          "absolute flex flex-col items-center transition-all duration-500 ease"
        }
      >
        ...
        {!displayMoreDetails && (
          <a
            onClick={(e) => setDisplayMoreDetails(true)}
            className="font-light text-green-700 cursor-pointer hover:text-green-500"
          >
            See details
          </a>
        )}
      ...
      {!displayMoreDetails && (
        <div
          ...
          className={
            "absolute flex flex-col items-center rounded transition-all duration-500 ease"
          }
        >
          <p>Price:</p>
      ...
      {displayEditButton && <DeleteModal confirmDelete={deleteInstallation} />}
    </div>
  );
}
