...
export default function SelfMadeProductInCart({product, cablesType, goToStep, index, deleteSMProduct, isReviewStep}) {
    ...
    return(
        <div 
            ...
            className={"relative flex flex-row justify-start items-center mb-3 sm:mx-3 lg:mx-0 rounded sm:p-3 lg:p-5 border bg-white border-gray-300 shadow " + (isReviewStep ? 'w-full' : 'lg:w-7/12')} 
        >
            <div className="lg:m-2 lg:p-3 flex flex-col justify-center items-center rounded border-gray-300 ">
                <div style={{height: '66px', width: (window?.innerWidth > 800 ? '100px' : '60px')}}> 
            ...
            <div style={{width: (window?.innerWidth > 800 ? '114px' : '80px')}} className="flex flex-col items-center mx-5">
