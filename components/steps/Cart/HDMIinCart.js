...
export default function HDMIinCart({
  selectedMonitor,
  cablesType,
  goToStep,
  deleteHDMI,
  ...
  if (!selectedMonitor?.cable)
    return (
      <div
        ...
        className={
          "relative flex flex-col items-center justify-center border rounded p-3 ml-3 sm:mr-3 lg:mr-3 sm:mt-3 lg:mt-0 bg-white border-gray-300 shadow lg:w-6/12"
        }
      >
  ...
  return (
    <div
      ...
      onMouseLeave={(e) => setDisplayEditButton(false)}
      className={
        "relative flex flex-col items-center justify-center border rounded p-3 ml-3 sm:mr-3 lg:mr-0 sm:mt-3 lg:mt-0 bg-white border-gray-300 shadow lg:w-6/12"
      }
    >
      ...
      {displayEditButton && <DeleteModal confirmDelete={deleteHDMI} />}
    </div>
  );
}
