...
export default function RecommendedCamera({ camera, handleSelect }) {
  ...
  const addToCart_styles =
    "px-3 py-1 border rounded bg-green-600 text-white text-sm uppercase tracking-wider font-semibold mt-3 transition hover:bg-green-400 focus:outline-none focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-500 ";
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        <p
          className={
            "font-light mb-1 " +
            (camera.resolution == "4K" ? "text-yellow-600" : "")
          }
        >
        ...
        <button
          className={addToCart_styles}
          onClick={(e) => handleSelect(camera)}
        >
          Select
        </button>
        <a
          ...
          target="_blank"
          className="font-light mt-2 text-green-600 hover:text-green-400"
        >
          See more details
        </a>
      </div>
