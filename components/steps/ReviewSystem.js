                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-row justify-start mb-3">
                        ...
                        {selectedHardDrives.length != 0 &&
                            <div className={"flex flex-row py-7 px-5 ml-3 justify-center items-center border rounded bg-white border-gray-300 shadow " + (cablesType == 'pre-made' ? 'w-3/12' : 'w-4/12')}>
                    ...
                    {selectedMonitor != '' &&
                        <div className="flex flex-row justify-start mb-3">
                            <div 
                                className={"flex flex-row justify-start items-center py-4 px-5 border rounded flex-shrink-0 bg-white border-gray-300 shadow  " + (cablesType == 'pre-made' ? 'w-6/12' : 'w-8/12')}
                            >
                                <div className="m-3" style={{height: '86px', width: '120px'}}> 
                                    <div style={{position: 'relative', maxWidth: '100%', height: '100%'}}>
                                        <Image
