    ...
    <section className="relative mt-10 sm:mb-48 lg:mb-0">
      <div className="flex justify-between sm:mb-7 lg:mb-0">
        <p className="font-light sm:text-lg lg:text-xl rounded p-3 bg-green-50 max-w-max sm:mx-6 lg:mx-0">
          ...
          You can change your selections by hovering the mouse over an item and
          clicking the{" "}
          <FaEdit className="fill-current text-yellow-600 inline mb-2 mx-1 text-2xl" />{" "}
          button. This will take you back to the related step.
        </p>
      ...
      <div
        className={
          "relative lg:p-6 flex flex-col overflow-y-auto lg:w-10/12 xl:w-9/12"
        }
      >
        <div className="flex flex-col">
          ...
          <div className="flex sm:flex-col lg:flex-row justify-start sm:mb-6 lg:mb-3 sm:bg-gray-200 lg:bg-white sm:py-5 lg:py-0">
            ...
            {
              <HardDriveInCart
                hardDrive={selectedHardDrives[0]}
                cablesType={cablesType}
                goToStep={goToStep}
                index={0}
