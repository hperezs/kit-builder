...
export default function Camera({
  ...
  return (
    <div
      style={{
        height: isEditing ? "498px" : "403px",
        transitionDuration: "0.4s",
      }}
      transition-style={isBeingDeleted ? "out:square:bottom-right" : "fade:in"}
      className={
        "relative flex flex-col justify-start items-center sm:my-2 lg:my-7 mx-3 border rounded p-5 bg-white shadow-xl transition-all ease flex-none " +
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="">{shortCameraName(camera?.name) || camera.sku} </p>
