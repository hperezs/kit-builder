...
export default function Camera({camera, index, updateCameraName, deleteCamera, duplicateCamera, lastIndex}) {
    ...
    return(
        <div 
            ...
            className={"relative flex flex-col justify-start items-center sm:my-2 lg:my-7 mx-3 border rounded p-5 bg-white shadow-xl transition-all ease flex-none " + (isEditing ? 'overflow-hidden' : '')}
        >
