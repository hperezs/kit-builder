...
export default function ChooseCameraSeries({cyberSecure, setCyberSecure, isCartNotEmpty, clearCart}) {
    ...
    return(
        <>
            ...
            <ConfirmSeriesModal isOpen={isModalOpen} confirm={confirmChoice} cancel={cancelChoice} />  
        </>
    )
}