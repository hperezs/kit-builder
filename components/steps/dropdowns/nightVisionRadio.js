...
export default function NightvisionRadio({setNightVisionDist}) {
    ...
    const radio_style = "mr-1 mb-1 border-gray-300 text-green-600 shadow-sm cursor-pointer focus:border-green-300 focus:ring focus:ring-offset-0 focus:ring-green-200 focus:ring-opacity-50"
