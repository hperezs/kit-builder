...
export default function ViewingAreaDropdown({
  viewingArea,
  setViewingArea,
  cameraHousing,
}) {
  ...
  const style =
    "inline w-40 ml-3 rounded-md border-gray-300 shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 ";
