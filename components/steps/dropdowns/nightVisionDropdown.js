...
export default function NightVisionDropdown({
  viewingArea,
  cameraHousing,
  nightVisionDist,
  setNightVisionDist,
  ...
  const classNames =
    "inline w-28 mt-1 rounded-md border-gray-300 shadow-sm focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 ";
  ...
  return (
    <select
      disabled={
        viewingArea == "Under 50 ft" || viewingArea == "200-1000 ft"
          ? true
          : false
      }
      value={selectedValue}
    ...
    >
      <option
        value="60ft"
        disabled={viewingArea != "Under 50 ft" ? true : false}
      >
        60ft+
      </option>
      <option value="70ft" disabled={viewingArea != "50-180 ft" ? true : false}>
        70 ft
      </option>
      <option value="90ft" disabled={viewingArea != "50-180 ft" ? true : false}>
        90 ft
      </option>
      <option value="120ft" disabled={cameraHousing != "bullet" ? true : false}>
        120 ft
      </option>
      <option value="180ft" disabled={cameraHousing != "bullet" ? true : false}>
        180 ft
      </option>
      <option value="240ft" disabled={cameraHousing != "bullet" ? true : false}>
        240 ft
      </option>
      <option
        value="300ft"
        disabled={viewingArea != "200-1000 ft" ? true : false}
      >
        300 ft
      </option>
    </select>
