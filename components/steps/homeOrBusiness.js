    ...
    return(
        <div className="flex flex-row justify-center">
            <section className="h-80 my-10 flex flex-row justify-around items-center 2xl:w-7/12 xl:w-9/12 md:w-10/12 ">
                <span className={"flex flex-col items-center text-center cursor-pointer sm:mx-3 lg:mx-0 sm:px-10 sm:py-8 lg:px-16 lg:py-8 border rounded border-gray-300 transition-colors transition-shadow " 
                    + (homeOrBusiness == 'home' ? selected : 'hover:shadow-lg hover:border-green-200 hover:bg-green-50')}
                    onClick={e => setHomeOrBusiness('home')}
                    >
                    <span className="sm:text-4xl lg:text-6xl text-gray-700"><AiOutlineHome /></span>
                ...
                <span className={"flex flex-col items-center text-center cursor-pointer sm:mx-3 lg:mx-0 sm:px-10 sm:py-8 lg:px-16 lg:py-8 border rounded border-gray-300 transition-colors transition-shadow " 
                    ...
                    >
                    <span className="sm:text-4xl lg:text-6xl text-gray-700"><HiOutlineOfficeBuilding className="ml-1"/></span>
