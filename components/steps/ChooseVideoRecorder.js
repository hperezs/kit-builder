...
export default function ChooseVideoRecorder({
  cameras,
  videoRecorders,
  selectedNVR,
  selectNVR,
  ...
  const card_styles =
    "relative flex flex-col justify-start items-center mt-7 mb-4 mx-3 rounded px-3 py-7 ";

  return (
    <section className="my-10">
      <p className="text-lg sm:px-5 lg:px-0">
        Select your video recorder according to the number of cameras you are
        purchasing.
      </p>
      ...
      {isChoosing && (
        <div
          ...
          className="mt-20 border rounded py-10 bg-gray-100"
        >
          <p className="text-center text-2xl font-light">
            You have selected{" "}
            <span className="text-green-600 font-normal">{cameras.length}</span>{" "}
            camera(s)
          </p>
