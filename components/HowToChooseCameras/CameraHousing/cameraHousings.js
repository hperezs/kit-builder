...
export default function CameraHousings() {
  ...
  return (
    <section id="cameraHousings" className="my-10 pb-20 ">
      ...
      <p className="ml-3 text-xl mb-14 text-center">
        There are 3 types of camera housings. Click on each one to see more
      ...
      <div className="flex flex-row justify-center items-center mt-5 mb-20 flex-wrap">
        <div
          style={{ width: "209px" }}
          className={
            "p-5 text-center mx-10 rounded border-black-200 " +
            (housingSelected == "dome"
              ? selected
              : "border hover:shadow-lg hover:border-green-200 cursor-pointer")
          }
          onClick={(e) => setHousingSelected("dome")}
        >
          <Image src="/images/dome-style.png" width={160} height={115} />
        ...
        <div
          ...
          className={
            "p-5 text-center mx-10 rounded border-black-200 " +
            (housingSelected == "bullet"
              ? selected
              : "border hover:shadow-lg hover:border-green-200 cursor-pointer")
          }
          onClick={(e) => setHousingSelected("bullet")}
        >
          <Image src="/images/bullet-style.png" width={160} height={115} />
          <h5 className="text-lg mt-3">Bullet style</h5>
        </div>
        ...
        >
          <Image src="/images/ptz-style.png" width={160} height={115} />
          <h5 className="text-lg mt-3">PTZ style</h5>
        </div>
      </div>
      <Description
