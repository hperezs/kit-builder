            ...
            <div className="flex flex-col items-center justify-center">
                <div className="lg:w-9/12 2xl:w-7/12">
                    <p>
                        ...
                        <br/> <br/>Often the right choice is a 3K camera for general medium range surveillance such as hallways or an office. The smaller resolution allows for smaller hard drives and 3K cameras cost less than 4K. However, if you want clear detail at a distance with superior digital zoom, then you should go with 4K cameras. Keep in mind that you can mix 3K and 4K cameras on the same system.
                    </p>
                    <br/>
                </div>
