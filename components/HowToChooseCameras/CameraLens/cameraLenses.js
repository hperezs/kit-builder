            ...
            <div className="flex flex-row justify-center">
                <div className="lg:w-8/12">
                    ...
                    <ul className="list-inside">
                        <li className="mb-4 p-4 border rounded shadow">If the viewing area is <span className="text-green-600 font-semibold">under 60 feet</span> from the camera, a <span className="text-green-600 font-semibold">3.6mm fixed lens</span> is recommended. This lens provides a wide angle for close objects.</li>
                        <li className="mb-4 p-4 border rounded shadow">If the viewing area is <span className="text-green-600 font-semibold">over 60 feet</span> from the camera, a <span className="text-green-600 font-semibold">2.8-12mm zoom lens</span> is recommended. The lens can be adjusted to provide clear images for close objects or for longer distances. This lense can be <span className="font-semibold text-green-600">manual</span> or <span className="font-semibold text-green-600">motorized</span>.</li>
                        <div className="flex text-center">
                            ...
                            <li className="mb-4 p-4 border rounded shadow ml-2">
                                ...
                                <p>This lens can be adjusted on the Video Recorder through software that controls the lens motor.</p>
                            </li>
                        </div>
