        ...
        <section className="my-10">
            <div className="flex flex-row justify-start">
                <div className="flex flex-row justify-evenly">
                    <p className="text-lg p-5 mx-5 border rounded">Now that we know the viewing area for each camera, it's easy to choose a lens.</p>
                                   
                    <div className="text-lg p-5 mx-5 border rounded"><p>Based on the viewing distance you entered, some of your camera lenses may have already been selected for you.</p>
                        <a className="block text-base text-right mt-5 text-green-600 cursor-pointer hover:text-green-500">How are my camera lenses automatically chosen?</a>
                    </div>
                    
                    <div className="text-lg p-5 mx-5 border rounded"><p>For your cameras with a viewing area of 50-180 ft, we need you to choose between a manual or motorized zoom lens.</p>
                        <a className="block text-base text-right mt-5 text-green-600 cursor-pointer hover:text-green-500">What's the difference?</a>
                    </div>
