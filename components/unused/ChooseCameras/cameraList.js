...
export default function CameraList({ cameras, allProducts }) {
  ...
  const edit_styles =
    "px-3 py-2 border rounded border-green-600 text-green-600 text-sm mt-3 transition hover:bg-green-500 hover:border-green-500 hover:text-white focus:outline-none focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50";
  const addToCart_styles =
    "px-3 py-1 border rounded bg-green-600 text-white text-sm mt-3 transition hover:bg-green-400 ";
      ...
      let outdoor_calculated_list = cameras?.outdoor.map((camera, index) => {
        ...
        let filteredProducts = allProductsCopy.filter((product) => {
          if (
            ...
            camera.cameraLens == "2.8-12mm manual"
          )
            return (
          ...
          if (
            camera.housing == "bullet" &&
            camera.cameraLens == "2.8-12mm motorized"
          )
            return (
              camera.housing == product.housingStyle &&
        ...
        <div className="flex flex-col justify-center items-start my-10 w-full">
          ...
          {outdoorCalculatedList.length != 0 && (
            <div className="w-full">
              <h3 className="text-2xl pb-3 text-center w-full">
                Outdoor Cameras
              </h3>
              <div className="flex flex-row justify-start w-full overflow-x-auto">
                <table className="mt-10 pr-10 w-full">
                  <tr className="border-b">
                    ...
                    <th className="font-normal py-5 border-t border-r">
                          ...
                          <div className="flex flex-col justify-start items-center flex-wrap ">
                            ...
                            <div className="flex flex-col items-center">
                              <p className="font-light mb-1">
                                Viewing Area: {cameraArray[0].viewingArea}
                              </p>
                              <p className="font-light mb-1">
                                Lens: {cameraArray[0].cameraLens}
                              </p>
                              <p className="font-light mb-1">
                                Night Vision: {cameraArray[0].nightVisionDist}
                              </p>
                              ...
                              >
                                <div className="m-4 p-5 flex flex-col justify-center items-center border rounded border-gray-300 ">
                                  ...
                                  >
                                    ...
                                    >
                                      <Image
                                        src={
                                          backstreet_domain + camera.imageLink
                                        }
                                        layout="fill"
                                        objectFit="contain"
                                        quality={100}
                                ...
                                <div className="flex flex-col items-center">
                                  ...
                                  <p className="font-normal text-green-600">
                                    ${camera.price?.$numberDecimal}
                                  </p>
                                  <button className={addToCart_styles}>
                                    Add to Cart
                                  </button>
                                </div>
                              </a>
