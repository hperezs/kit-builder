    ...
    <div className="flex flex-row justify-center">
      <section className="h-80 my-10 flex flex-col justify-center items-center 2xl:w-8/12">
        <div className="flex flex-row w-full justify-around items-center">
          <div
            className={
              "flex flex-col justify-center items-center cursor-pointer px-10 py-8 border rounded border-gray-300 transition-colors transition-shadow " +
              (cviOrIp == "cvi"
                ? selected
          ...
          >
            ...
            <h5 className="text-xl mt-4 font-light">
              Video over Coax Cable (CVI)
            </h5>
          </div>
          ...
          >
            ...
            <h5 className="text-xl mt-4 font-light">
              Video Over Ethernet (IP-based)
            </h5>
          </div>
        </div>

        <span
          className="text-center mt-5 text-green-600 cursor-pointer"
          onClick={(e) => setDisplaySystemTypeInfo(true)}
        >
          <BsInfoCircle className="inline mb-1 mr-1" /> Which one should I
          choose?
        </span>

        <div
          className={"w-8/12 mt-5 " + (displaySystemTypeInfo ? "" : "hidden")}
        >
          <p>
