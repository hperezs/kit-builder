  ...
  return (
    <>
      <div
        ...
        className="flex justify-center items-center bg-white border-b"
      >
      ...
      <main className="flex flex-col items-center bg-gray-100 pb-20">
        <div
          ...
          className="mt-20 border rounded bg-white shadow"
        >
          <div className="flex border-b">
            <div
              onClick={(e) => setSelectedTab("Total Traffic")}
              className={
                "flex items-center justify-center py-7 px-12 text-2xl border-r w-4/12 cursor-pointer " +
                (selectedTab == "Total Traffic"
                  ? "bg-green-50"
                  : "hover:bg-gray-50")
              }
            >
            ...
            <div
              ...
              className={
                "flex items-center justify-center py-7 px-12 text-2xl border-r w-4/12 cursor-pointer " +
                (selectedTab == "Users" ? "bg-green-50" : "hover:bg-gray-50")
              }
            >
              Users
            </div>
