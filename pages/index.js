            ...
            <main className=" relative h-screen w-screen">
                ...
                <section className="welcome-container flex flex-col items-center w-screen border-b border-gray-400">
                    <div className="flex flex-col justify-center w-screen ">
                        <div style={{borderTopWidth: '5px'}} className="flex flex-col items-center justify-start border-green-600">
                            <h2 className="text-4xl font-semibold mt-14 text-green-800">Build Your Custom Surveillance System in Minutes</h2>
                            <p style={{maxWidth: '850px'}} className="text-2xl text-center w-6/12 my-10">
                            ...
                            <a style={{paddingBottom: '14px', paddingRight: '41px'}} onClick={handleClick} className="py-3 px-10 mb-5 text-white border bg-green-700 bg-opacity-90 text-3xl rounded text-white text-center align-middle transition-colors duration-300 ease hover:bg-green-500 my`-8 cursor-pointer">
                                Get started
                            </a>
                ...
                <section className="mx-20 p-10 col items-center">
                    ...
                    <div className="flex justify-center items-center mb-10">
                        ...
                        <div style={{height: '200px', width: '280px'}} className="ml-20"> 
                            <div style={{position: 'relative', maxWidth: '100%', height: '100%'}}>
                                <NextImage
                ...
                <section className="flex flex-col items-center justify-center bg-green-700 text-gray-50 py-12">
                    <h5 className="need-help">Need More Information About Security Cameras?</h5>
